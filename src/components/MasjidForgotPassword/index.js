...
const ForgotPassword = () => {
  ...
  const sendResetLink = () => {
    fetch('YOUR_BACKEND_URL/reset-password', {
      method: 'POST',
      headers: {
    ...
    <div className='masid-singin-main-container'>
      <div className='masid-signin-container'>
        ...
        <form className='masid-signin-form' onSubmit={handleSubmit}>
          ...
          <div>
            <Link to={'/MasidLogin'}  style={{textDecoration:'none',color:'#1e88e5',fontSize:'14px'}}>
            <p> Already have an account! Log In</p>
            </Link>
          </div>
          <div className=''>
            <button className='app-container-button' type="submit">RESET PASSWORD</button>
          </div>
        </form>
      </div>
